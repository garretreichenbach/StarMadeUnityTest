...
public class Image  {
	...
	public Image(String ref, boolean flipped, int f, Color transparent) throws SlickException {
		this.filter = f == FILTER_LINEAR ? GL11.GL_LINEAR : GL11.GL_NEAREST;
...
//	}
    ...
    public void drawSheared(float x,float y, float hshear, float vshear, Color filter) { 
        ...
        GL11.glBegin(GL11.GL_QUADS); 
			...
			GL11.glTexCoord2f(textureOffsetX, textureOffsetY + textureHeight);
			GL11.glVertex3f(hshear, height, 0);
			GL11.glTexCoord2f(textureOffsetX + textureWidth, textureOffsetY
					+ textureHeight);
			GL11.glVertex3f(width + hshear, height + vshear, 0);
			GL11.glTexCoord2f(textureOffsetX + textureWidth, textureOffsetY);
			GL11.glVertex3f(width, vshear, 0);
        GL11.glEnd(); 
...
//		if (GL11.canSecondaryColor()) {
//			GL11.glEnable(GL11.GL_COLOR_SUM_EXT);
//			GL11.glSecondaryColor3ubEXT((byte)(col.r * 255), 
//													 (byte)(col.g * 255), 
//													 (byte)(col.b * 255));
//		}
...
//		if (GL11.canSecondaryColor()) {
//			GL11.glDisable(GL11.GL_COLOR_SUM_EXT);
//		}
	}
...
//		GL11.glEnd();
	...
	public void drawWarped(float x1, float y1, float x2, float y2, float x3, float y3, float x4, float y4) {
        ...
        GL11.glVertex3f(0, 0, 0);
        GL11.glTexCoord2f(textureOffsetX, textureOffsetY + textureHeight);
        GL11.glVertex3f(x2 - x1, y2 - y1, 0);
        GL11.glTexCoord2f(textureOffsetX + textureWidth, textureOffsetY
                + textureHeight);
        GL11.glVertex3f(x3 - x1, y3 - y1, 0);
        GL11.glTexCoord2f(textureOffsetX + textureWidth, textureOffsetY);
        GL11.glVertex3f(x4 - x1, y4 - y1, 0);
        GL11.glEnd();
