...
public class Spline2DAlt {
	 ...
	 * @param points
	 */
	public Spline2DAlt(Point2D[] points) {
	 ...
	 * @param y
	 */
	public Spline2DAlt(double[] x, double[] y) {
		init(x, y);
	}

	public Spline2DAlt(List<Point2D.Double> points) {
	...
	public double getValueX(double t) {
		return splineX.getValue(t);
	}

	public double getValueY(double t) {

		return splineY.getValue(t);
	}
