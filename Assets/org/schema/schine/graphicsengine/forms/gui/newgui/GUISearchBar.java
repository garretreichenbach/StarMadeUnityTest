...
public class GUISearchBar extends GUIActivatableTextBar implements GUICallback {

	public GUISearchBar(InputState state, GUIElement dependent,
	...
	public GUISearchBar(InputState state, String inactiveText, GUIElement dependent,
	                    TextCallback textCallback, OnInputChangedCallback onInputChangedCallback) {
