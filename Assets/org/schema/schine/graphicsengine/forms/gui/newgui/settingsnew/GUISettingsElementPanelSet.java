...
public class GUISettingsElementPanelSet extends GUIAnchor implements TooltipProvider {
	...
	public GUISettingsElementPanelSet(InputState state, int width, int height, GUIElement settingsElement, boolean backGroundShade, boolean horizontal) {
		super(state);
	...
	public GUISettingsElementPanelSet(InputState state, GUIElement settingsElement, boolean backGroundShade, boolean horizontal) {
		this(state, UIScale.getUIScale().scale(300), UIScale.getUIScale().scale(60), settingsElement, backGroundShade, horizontal);
	}
	...
	public void draw() {
		...
		if (settingElement instanceof GUIEngineSettingsCheckBox) {
			settingElement.getPos().x = UIScale.getUIScale().scale(10);
			settingElement.getPos().y = UIScale.getUIScale().scale(6);

		} else {
			settingElement.getPos().y = UIScale.getUIScale().scale(-2);
	...
	public void drawToolTip() {
		if (settingElement instanceof GUISettingsElement){
			((GUISettingsElementPanelSet) settingElement).drawToolTip();
		}
	}
