...
public class GraphicsPresetCompatibilityHigh extends EngineSettingsPreset{

	public GraphicsPresetCompatibilityHigh() {
		super("GRAPHICS_COMPATIBILITY_HIGH");
	}

	@Override
	public String getName() {
		return Lng.str("Compatibility Mode High");
	}
	...
	public void init() {
		...
		addSetting(EngineSettings.G_MULTI_SAMPLE, 2);
		...
		addSetting(EngineSettings.G_STAR_COUNT, 16384); // star count
		...
		addSetting(EngineSettings.G_MAX_MISSILE_TRAILS, 256); // max missile trails

		addSetting(EngineSettings.G_MAX_SEGMENTSDRAWN, 3000); // max segments
