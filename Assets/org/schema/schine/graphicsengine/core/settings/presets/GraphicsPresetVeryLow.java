...
public class GraphicsPresetVeryLow extends EngineSettingsPreset{

	public GraphicsPresetVeryLow() {
		super("GRAPHICS_VERY_LOW");
	}

	@Override
	public String getName() {
		return Lng.str("Very Low");
	}
	...
	public void init() {
		...
		addSetting(EngineSettings.G_SHADOW_QUALITY, ShadowQuality.BAREBONE); // shadow quality
