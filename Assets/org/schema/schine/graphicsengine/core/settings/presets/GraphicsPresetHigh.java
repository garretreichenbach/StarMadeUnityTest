...
public class GraphicsPresetHigh extends EngineSettingsPreset {

	public GraphicsPresetHigh() {
		super("GRAPHICS_HIGH");
	}
	...
	public void init() {
		...
		addSetting(EngineSettings.G_MULTI_SAMPLE, 8);
		...
		addSetting(EngineSettings.G_MAX_SEGMENTSDRAWN, 7000); // max segments
		...
		addSetting(EngineSettings.LOD_DISTANCE_IN_THRESHOLD, 300f); // lod distance
	}
}
