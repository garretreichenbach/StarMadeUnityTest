...
public class TextValues {
	...
	public static final String formatDateTime(long timestamp, String format) {
		...
		for (int i = 0; i < format.length(); i++) {
			switch(format.charAt(i)) {
				case 'Y' -> sb.append(yyyy0);
				case 'M' -> sb.append(mm0);
				case 'D' -> sb.append(dd0);
				case 'h' -> sb.append(h0);
				case 'm' -> sb.append(m0);
				case 's' -> sb.append(s0);
				case 'S' -> sb.append(ms0);
				default -> sb.append(format.charAt(i));
			}
		}
	...
	public static final String formatElapsedTime(long ms, String format) {
		...
		for (int i = 0; i < format.length(); i++) {
			switch(format.charAt(i)) {
				case 'S' -> sb.append(ss0);
				case 'M' -> sb.append(mm0);
				case 'H' -> sb.append(hh0);
				default -> sb.append(format.charAt(i));
			}
		}
