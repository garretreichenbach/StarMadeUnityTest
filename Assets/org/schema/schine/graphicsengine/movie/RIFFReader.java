...
//        ckSize = swap32(dIn.readInt());

        avail = 4;//this.ckSize;

        System.err.println("GETFORMAT: "+this.fourcc+"; "+this.ckSize);
        
        if (this.fourcc.equals("RIFF") || this.fourcc.equals("LIST")) {
    ...
    public long readUnsignedInt() throws IOException {
    	System.err.println("FP: "+filepointer);
        long ch1 = read();
        long ch2 = read();
        long ch3 = read();
        long ch4 = read();
