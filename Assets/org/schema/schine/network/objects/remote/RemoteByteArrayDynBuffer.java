...
public class RemoteByteArrayDynBuffer extends RemoteBuffer<RemoteByteArrayDyn> {

	private static final int CONTROL_BATCH = 16;

	public RemoteByteArrayDynBuffer(NetworkObject synchOn) {
		super(RemoteByteArrayDyn.class, synchOn);
	}
	...
	public void fromByteStream(DataInputStream buffer, int updateSenderStateId) throws IOException {
		...
		for (int n = 0; n < collectionSize; n++) {
			...
			RemoteByteArrayDyn instance = new RemoteByteArrayDyn(new byte[size], onServer);
