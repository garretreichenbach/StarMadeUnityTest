...
public enum GameServerSettings implements Settings{
	...
	SPAM_PROTECTION_EXCEPTIONS(new SettingStateString("")),
	...
	LISTENING_ON_NT_INTERFACE(new SettingStateString("all")), 
	SPAM_PROTECTION_ATTEMPTS(new SettingStateInt(-1, -1, Integer.MAX_VALUE)),  
	SPAM_PROTECTION_ATTEMPT_TIMEOUT_MS(new SettingStateInt(60000, 0, Integer.MAX_VALUE)),   
	
	CLIENT_CONNECT_TIMEOUT_MS(new SettingStateInt(10000, 0, Integer.MAX_VALUE)),
	
	
	CLIENT_TIMEOUT(new SettingStateInt(1000 * 60 * 60, 0, Integer.MAX_VALUE)),  //3 min timeout
	;
	public final SettingState s;

	private GameServerSettings(SettingState s) {
		this.s = s;
	}
