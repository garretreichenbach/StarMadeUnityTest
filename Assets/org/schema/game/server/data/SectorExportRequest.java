...
public class SectorExportRequest implements ServerExecutionJob {
	public Vector3i pos;
	public RegisteredClientInterface client;
	private String name;

	public SectorExportRequest(Vector3i pos,
	...
	public boolean execute(GameServerState state) {
		try {
			SectorUtil.exportSector(pos, name, state);
			if (client != null) {
				client.serverMessage("sector " + pos + " exporting successful to " + name);
			}
			return true;
