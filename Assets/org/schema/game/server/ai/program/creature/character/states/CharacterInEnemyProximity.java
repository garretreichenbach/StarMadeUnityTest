...
public class CharacterInEnemyProximity extends CharacterState {
	...
	public CharacterInEnemyProximity(AiEntityStateInterface gObj, AICreatureMachineInterface mic) {
		super(gObj, mic);
	}
