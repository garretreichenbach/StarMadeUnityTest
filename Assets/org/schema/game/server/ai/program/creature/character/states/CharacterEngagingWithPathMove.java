...
public class CharacterEngagingWithPathMove extends CharacterState {
	...
	public CharacterEngagingWithPathMove(AiEntityStateInterface gObj, AICreatureMachineInterface mic) {
		super(gObj, mic);
	}
