...
import org.schema.game.common.controller.pathfinding.SegmentPathGroundCalculator;
import org.schema.game.common.data.element.ElementKeyMap;
import org.schema.game.server.data.GameServerState;

import it.unimi.dsi.fastutil.longs.LongArrayList;

public class SegmentPathGroundFindingHandler extends AbstractPathFindingHandler<SegmentPathGroundCalculator, SegmentPathRequest> {

	private boolean foundCore;
	private SegmentPathRequest currentPathRequest;
	private LongArrayList deepCopy;

	public SegmentPathGroundFindingHandler(GameServerState state) {
		super(state, "SegmentPFG", new SegmentPathGroundCalculator());
	}
