...
public class WorldCreatorPlanetEarthFactory extends WorldCreatorPlanetFactory {

	private TerrainDeco[] minable;

	public WorldCreatorPlanetEarthFactory(long seed, Vector3f[] poly, float radius) {
		...
		//		minable[0] = new GeneratorResourcePlugin(ElementKeyMap.TERRAIN_IRIDIUM_ID, 4, ElementKeyMap.TERRAIN_ROCK_ID);
		//		minable[1] = new GeneratorResourcePlugin(ElementKeyMap.TERRAIN_PLATINUM_ID, 8, ElementKeyMap.TERRAIN_ROCK_ID);
		//		minable[2] = new GeneratorResourcePlugin(ElementKeyMap.TERRAIN_MERCURY_ID, 6, ElementKeyMap.TERRAIN_ROCK_ID);
		//		minable[3] = new GeneratorResourcePlugin(ElementKeyMap.TERRAIN_PALLADIUM_ID, 3, ElementKeyMap.TERRAIN_ROCK_ID);
