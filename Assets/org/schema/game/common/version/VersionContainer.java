...
public class VersionContainer {
	...
	public static String UPDATE_NAME = "Universe Update";
	...
	public static void loadVersion(String installDir) {
		...
		try {
			File f = new FileExt(installDir + devVersionFile);
			...
			if(f.exists()) {
				...
				f = new FileExt(installDir + versionFile);
				if(f.exists()) {
					BufferedReader b = new BufferedReader(new FileReader(f, StandardCharsets.UTF_8));
