...
public class StarmoteEntitySearchDialog extends JDialog {
	 ...
	 * Create the dialog.
	 */
	public StarmoteEntitySearchDialog(final GameClientState state) {
		...
		{
			JLabel lblEnterPlayerName = new JLabel("Enter Search Term");
		...
		}
		{
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				okButton.addActionListener(e -> {
					state.getController().sendAdminCommand(AdminCommands.SEARCH, textField.getText().trim(), "no description");
					dispose();
				});
