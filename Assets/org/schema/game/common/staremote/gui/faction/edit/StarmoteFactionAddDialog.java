...
public class StarmoteFactionAddDialog extends JDialog {
	 ...
	 * Create the dialog.
	 */
	public StarmoteFactionAddDialog(final GameClientState state) {
		...
		{
			JLabel lblEnterPlayerName = new JLabel("Enter Faction Name");
		...
		}
		{
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				okButton.addActionListener(e -> {
					state.getController().sendAdminCommand(AdminCommands.FACTION_CREATE, textField.getText().trim(), "no description");
					dispose();
				});
