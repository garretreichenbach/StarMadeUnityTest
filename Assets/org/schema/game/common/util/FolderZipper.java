...
public class FolderZipper {
	...
	private static void addFolderToZip(String path, String srcFolder,
	                                   ZipOutputStream zip, String startsWithFilter, byte[] buf, ZipCallback cb, FileFilter filter) {

		path.replace('\\', '/');
		srcFolder.replace('\\', '/');

		File folder = new FileExt(srcFolder);
	...
	private static void addToZip(String path, String srcFile, ZipOutputStream zip, String startsWithFilter, byte[] buf, ZipCallback cb, FileFilter filter) {
		...
		File folder = new FileExt(srcFile);
	...
	public static void zipFolder(String srcFolder, String destZipFile, String startsWithFilter, ZipCallback cb, String pathPrefix, FileFilter filter, boolean skipSelfFolder) throws IOException {
		...
		destZipFile.replace('\\', '/');
		srcFolder.replace('\\', '/');
		File destFile = new FileExt(destZipFile);
		File src = new FileExt(srcFolder);
