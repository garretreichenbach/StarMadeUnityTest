...
public class ProjectileHandlerDefault extends ProjectileHandler{
	...
	public ProjectileHandleState handle(Damager damager, ProjectileController projectileController,
			...
			CubeRayCastResult rayCallbackInitial) {
		throw new RuntimeException("Cannot handle collisions for: "+rayCallbackInitial.collisionObject);
	}
}
