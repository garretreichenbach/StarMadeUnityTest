...
public class SegmentControllerFactionCondition extends SegmentControllerCondition{
	...
	public SegmentControllerFactionCondition() {
		super();
	}

	@Override
	public long getTrigger() {
		return TRIGGER_ON_FACTION_CHANGE;
	}
	...
	protected boolean processCondition(short conditionIndex, RuleStateChange stateChange, SegmentController a, long trigger, boolean forceTrue) {
		...
		return factionRange.isInRange(a.getFactionId());
	}
	...
	public String getDescriptionShort() {
		...
		return Lng.str("Is entity in faction [from, to]: %s", String.valueOf(factionRange));
	}
}
