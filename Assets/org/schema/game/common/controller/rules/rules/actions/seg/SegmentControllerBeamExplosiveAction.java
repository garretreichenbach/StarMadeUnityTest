...
public class SegmentControllerBeamExplosiveAction extends SegmentControllerExplosiveAction {
	
	

	public SegmentControllerBeamExplosiveAction() {
		super();
	}

	@Override
	public String getExplName() {
		return Lng.str("Beam Modules");
	}
	...
	public UsableElementManager<?, ?, ?> getElementManager(ManagedUsableSegmentController<?> se) {
		if(se.getManagerContainer() instanceof WeaponManagerInterface) {
			return ((WeaponManagerInterface)se.getManagerContainer()).getBeam().getElementManager();
		}
		return null;
	}
	...
	public ActionTypes getType() {
		return ActionTypes.SEG_BEAM_EXPLOSIVE;
	}
