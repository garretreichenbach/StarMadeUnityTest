...
public class SegmentControllerModFactionPointsAction extends SegmentControllerAction{

	
	@RuleValue(tag = "FactionPoints")
	public int points;
	
	public SegmentControllerModFactionPointsAction() {
		super();
	}
	@Override
	public String getDescriptionShort() {
		return Lng.str("Gives entity's faction %s faction points", points);
	}
	...
	public ActionTypes getType() {
		return ActionTypes.SEG_MOD_FACTION_POINTS;
	}
}
