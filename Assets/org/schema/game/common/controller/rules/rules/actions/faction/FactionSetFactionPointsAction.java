...
public class FactionSetFactionPointsAction extends FactionAction{
	@RuleValue(tag = "FactionPoints")
	public int points;
	
	@Override
	public String getDescriptionShort() {
		return Lng.str("Set %s faction points", points);
	}
	...
	public ActionTypes getType() {
		return ActionTypes.FACTION_SET_FACTION_POINTS;
	}
