...
public class SegmentController2FactionAction extends SegmentControllerAction{
	...
	public SegmentController2FactionAction() {
		super();
	}
	@Override
	public String getDescriptionShort() {
		return Lng.str("Execute %s actions for faction of entity", actions.size());
	}
	...
	public void onTrigger(SegmentController s) {
		if(s.isOnServer()) {
			...
			if(state.getFactionManager().existsFaction(s.getFactionId())) {
				facs.add(state.getFactionManager().getFaction(s.getFactionId()));
			}
	...
	public ActionTypes getType() {
		return ActionTypes.SEG_2_FACTION;
	}
}
