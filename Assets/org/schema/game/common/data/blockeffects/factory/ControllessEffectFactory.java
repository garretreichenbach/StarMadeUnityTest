...
public class ControllessEffectFactory implements BlockEffectFactory<ControllessEffect> {
	@Override
	...
	@Override
	public ControllessEffect getInstanceFromNT(SendableSegmentController controller) {
		return new ControllessEffect(controller);
	}

	@Override
	public void setFrom(ControllessEffect to) {
