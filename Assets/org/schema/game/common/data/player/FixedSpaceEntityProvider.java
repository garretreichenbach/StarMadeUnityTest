...
public class FixedSpaceEntityProvider extends GenericProvider<AbstractCharacter<AbstractOwnerState>>{

	private NetworkEntityProvider networkEntityProvider;

	public FixedSpaceEntityProvider(StateInterface state) {
		super(state);
	}
	...
	public SendableType getSendableType() {
		return SendableTypes.FIXED_SPACE_ENTITY_PROVIDER;
	}
}
