...
public class DialogTextState extends DialogTimedState {
	...
	public DialogTextState(AiEntityStateInterface gObj, StateInterface state, DialogTextEntryHook hook, String message, long durationInMs) {
		this(gObj, state, hook, new Object[]{message}, durationInMs);
	}
	public DialogTextState(AiEntityStateInterface gObj, StateInterface state, DialogTextEntryHook hook, Object[] message, long durationInMs) {
