...
class Face {
	...
	int mark = VISIBLE;
	DVertex outside;
	private DVector3d normal;
	private DPoint3d centroid;

	public Face() {
		normal = new DVector3d();
		centroid = new DPoint3d();
		mark = VISIBLE;
	}

	public static Face createTriangle(DVertex v0, DVertex v1, DVertex v2) {
	...
	public static Face create(DVertex[] vtxArray, int[] indices) {
		Face face = new Face();
	...
	public void computeCentroid(DPoint3d centroid) {
		centroid.setZero();
		HalfEdge he = he0;
		do {
	...
	public void computeNormal(DVector3d normal, double minArea) {
		...
		if (area < minArea) {
			...
			DPoint3d p2 = hedgeMax.head().pnt;
			DPoint3d p1 = hedgeMax.tail().pnt;
	...
	public void computeNormal(DVector3d normal) {
		HalfEdge he1 = he0.next;
		HalfEdge he2 = he1.next;

		DPoint3d p0 = he0.head().pnt;
		DPoint3d p2 = he1.head().pnt;
	 ...
	 */
	public HalfEdge findEdge(DVertex vt, DVertex vh) {
		HalfEdge he = he0;
		do {
	 ...
	 */
	public double distanceToPlane(DPoint3d p) {
