...
public class DVector3d {
	 ...
	 */
	public DVector3d(double x, double y, double z) {
		set(x, y, z);
	}
	 ...
	 */
	public void add(DVector3d v1, DVector3d v2) {
		x = v1.x + v2.x;
		y = v1.y + v2.y;
		z = v1.z + v2.z;
	}
	 ...
	 * @param v2 right-hand vector
	 */
	public void sub(DVector3d v1, DVector3d v2) {
		x = v1.x - v2.x;
		y = v1.y - v2.y;
		z = v1.z - v2.z;
	}
	 ...
	 */
	public void scale(double s, DVector3d v1) {
		x = s * v1.x;
		y = s * v1.y;
		z = s * v1.z;
	}
	 ...
	 */
	public double distance(DVector3d v) {
		double dx = x - v.x;
		double dy = y - v.y;
		double dz = z - v.z;
	 ...
	 */
	public double distanceSquared(DVector3d v) {
		double dx = x - v.x;
		double dy = y - v.y;
		double dz = z - v.z;
	 ...
	 * @return dot product
	 */
	public double dot(DVector3d v1) {
	 ...
	 * @param v2 right-hand vector
	 */
	public void cross(DVector3d v1, DVector3d v2) {
