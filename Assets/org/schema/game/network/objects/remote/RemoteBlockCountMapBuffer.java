...
public class RemoteBlockCountMapBuffer extends RemoteBuffer<RemoteBlockCountMap> {

	private static final int CONTROL_BATCH = 32;

	public RemoteBlockCountMapBuffer(NetworkObject synchOn) {
		super(RemoteBlockCountMap.class, synchOn);
	}
	...
	public void fromByteStream(DataInputStream buffer, int updateSenderStateId) throws IOException {
		...
		for (int n = 0; n < collectionSize; n++) {
			RemoteBlockCountMap instance = new RemoteBlockCountMap(new ElementCountMap(), onServer);
