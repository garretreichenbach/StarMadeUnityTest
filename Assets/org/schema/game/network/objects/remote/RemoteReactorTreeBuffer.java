...
public class RemoteReactorTreeBuffer extends RemoteBuffer<RemoteReactorTree> {

	private static final int CONTROL_BATCH = 16;
	private final PowerInterface pw;

	public RemoteReactorTreeBuffer(NetworkObject synchOn, PowerInterface pw) {
		super(RemoteReactorTree.class, synchOn);
		this.pw = pw;
	}
	...
	public void fromByteStream(DataInputStream buffer, int updateSenderStateId) throws IOException {
		...
		for (int n = 0; n < collectionSize; n++) {
			RemoteReactorTree instance = new RemoteReactorTree(new ReactorTree(pw), onServer);
