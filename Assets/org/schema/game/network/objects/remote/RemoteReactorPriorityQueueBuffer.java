...
public class RemoteReactorPriorityQueueBuffer extends RemoteBuffer<RemoteReactorPriorityQueue> {

	private static final int CONTROL_BATCH = 16;
	private final PowerInterface pw;

	public RemoteReactorPriorityQueueBuffer(NetworkObject synchOn, PowerInterface pw) {
		super(RemoteReactorPriorityQueue.class, synchOn);
		this.pw = pw;
	}
	...
	public void fromByteStream(DataInputStream buffer, int updateSenderStateId) throws IOException {
		...
		for (int n = 0; n < collectionSize; n++) {
			RemoteReactorPriorityQueue instance = new RemoteReactorPriorityQueue(pw.getPowerConsumerPriorityQueue(), onServer);
