...
public class RemoteSimpleCommandBuffer extends RemoteBuffer<RemoteSimpelCommand> {

	private static final int CONTROL_BATCH = 128;
	private final SimpleCommandFactoryInterface cmd;

	public RemoteSimpleCommandBuffer(NetworkObject synchOn, SimpleCommandFactoryInterface cmd) {
		super(RemoteSimpelCommand.class, synchOn);
		this.cmd = cmd;
	}
	...
	public void fromByteStream(DataInputStream buffer, int updateSenderStateId) throws IOException {
		...
		for (int n = 0; n < collectionSize; n++) {
			RemoteSimpelCommand instance = new RemoteSimpelCommand(cmd.getNewCommand(), onServer);
