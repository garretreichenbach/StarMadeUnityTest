...
public class RemoteChatMessageBuffer extends RemoteBuffer<RemoteChatMessage> {

	private static final int CONTROL_BATCH = 16;

	public RemoteChatMessageBuffer(boolean synchOn) {
		super(RemoteChatMessage.class, synchOn);
	}

	public RemoteChatMessageBuffer(NetworkObject synchOn) {
		super(RemoteChatMessage.class, synchOn);
	}
	...
	public void fromByteStream(DataInputStream buffer, int updateSenderStateId) throws IOException {
		...
		for (int n = 0; n < collectionSize; n++) {
			RemoteChatMessage instance = new RemoteChatMessage(new ChatMessage(), onServer);
