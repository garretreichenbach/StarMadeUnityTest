...
public class RemoteRailMoveRequestBuffer extends RemoteBuffer<RemoteRailMoveRequest> {

	private static final int CONTROL_BATCH = 16;

	public RemoteRailMoveRequestBuffer(NetworkObject synchOn) {
		super(RemoteRailMoveRequest.class, synchOn);
	}
	...
	public void fromByteStream(DataInputStream buffer, int updateSenderStateId) throws IOException {
		...
		for (int n = 0; n < collectionSize; n++) {
			RemoteRailMoveRequest instance = new RemoteRailMoveRequest(new RailMove(), onServer);
