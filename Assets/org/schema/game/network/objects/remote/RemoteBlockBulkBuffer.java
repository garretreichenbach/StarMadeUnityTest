...
public class RemoteBlockBulkBuffer extends RemoteBuffer<RemoteBlockBulk> {

	private static final int CONTROL_BATCH = 32;

	public RemoteBlockBulkBuffer(boolean synchOn) {
		super(RemoteBlockBulk.class, synchOn);
	}

	public RemoteBlockBulkBuffer(NetworkObject synchOn) {
		super(RemoteBlockBulk.class, synchOn);
	}
	...
	public void fromByteStream(DataInputStream buffer, int updateSenderStateId) throws IOException {
		...
		for (int n = 0; n < collectionSize; n++) {
			RemoteBlockBulk instance = new RemoteBlockBulk(new BlockBulkSerialization(), onServer);
