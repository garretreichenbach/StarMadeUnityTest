...
public class RemoteInterconnectStructureBuffer extends RemoteBuffer<RemoteInterconnectStructure> {

	private static final int CONTROL_BATCH = 8;

	public RemoteInterconnectStructureBuffer(NetworkObject synchOn) {
		super(RemoteInterconnectStructure.class, synchOn);
	}
	...
	public void fromByteStream(DataInputStream buffer, int updateSenderStateId) throws IOException {
		...
		for (int n = 0; n < collectionSize; n++) {
			RemoteInterconnectStructure instance = new RemoteInterconnectStructure(new InterconnectStructureRequest(), onServer);
