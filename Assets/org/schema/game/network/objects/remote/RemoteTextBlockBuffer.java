...
public class RemoteTextBlockBuffer extends RemoteBuffer<RemoteTextBlockPair> {

	private static final int CONTROL_BATCH = 8;

	public RemoteTextBlockBuffer(NetworkObject synchOn) {
		super(RemoteTextBlockPair.class, synchOn);
	}
	...
	public void fromByteStream(DataInputStream buffer, int updateSenderStateId) throws IOException {
		...
		for (int n = 0; n < collectionSize; n++) {
			RemoteTextBlockPair instance = new RemoteTextBlockPair(new TextBlockPair(), onServer);
