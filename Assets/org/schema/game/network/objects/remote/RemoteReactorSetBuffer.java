...
public class RemoteReactorSetBuffer extends RemoteBuffer<RemoteReactorSet> {

	private static final int CONTROL_BATCH = 16;
	private PowerInterface pw;

	public RemoteReactorSetBuffer(NetworkObject synchOn, PowerInterface pw) {
		super(RemoteReactorSet.class, synchOn);
		this.pw = pw;
	}
	...
	public void fromByteStream(DataInputStream buffer, int updateSenderStateId) throws IOException {
		...
		for (int n = 0; n < collectionSize; n++) {
			RemoteReactorSet instance = new RemoteReactorSet(new ReactorSet(pw), onServer);
