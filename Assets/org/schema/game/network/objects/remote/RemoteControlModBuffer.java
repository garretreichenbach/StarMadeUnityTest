...
public class RemoteControlModBuffer extends RemoteBuffer<RemoteControlMod> {

	private static final int CONTROL_BATCH = 32;

	public RemoteControlModBuffer(NetworkObject synchOn) {
		super(RemoteControlMod.class, synchOn);
	}
	...
	public void fromByteStream(DataInputStream buffer, int updateSenderStateId) throws IOException {
		...
		for (int n = 0; n < collectionSize; n++) {
			RemoteControlMod instance = new RemoteControlMod(new SendableControlMod(), onServer);
