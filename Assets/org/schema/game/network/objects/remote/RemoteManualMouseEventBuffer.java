...
public class RemoteManualMouseEventBuffer extends RemoteBuffer<RemoteManualMouseEvent> {

	private static final int CONTROL_BATCH = 32;

	public RemoteManualMouseEventBuffer(boolean synchOn) {
		super(RemoteManualMouseEvent.class, synchOn);
	}

	public RemoteManualMouseEventBuffer(NetworkObject synchOn) {
		super(RemoteManualMouseEvent.class, synchOn);
	}
	...
	public void fromByteStream(DataInputStream buffer, int updateSenderStateId) throws IOException {
		...
		for (int n = 0; n < collectionSize; n++) {
			RemoteManualMouseEvent instance = new RemoteManualMouseEvent(new ManualMouseEvent(), onServer);
