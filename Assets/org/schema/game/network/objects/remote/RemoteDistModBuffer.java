...
public class RemoteDistModBuffer extends RemoteBuffer<RemoteDistMod> {

	private static final int CONTROL_BATCH = 32;

	public RemoteDistModBuffer(NetworkObject synchOn) {
		super(RemoteDistMod.class, synchOn);
	}
	...
	public void fromByteStream(DataInputStream buffer, int updateSenderStateId) throws IOException {
		...
		for (int n = 0; n < collectionSize; n++) {
			RemoteDistMod instance = new RemoteDistMod(new DistMod(), onServer);
