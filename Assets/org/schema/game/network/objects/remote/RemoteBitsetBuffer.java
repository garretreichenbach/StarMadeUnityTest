...
public class RemoteBitsetBuffer extends RemoteBuffer<RemoteBitset> {

	private static final int CONTROL_BATCH = 32;

	public RemoteBitsetBuffer(NetworkObject synchOn) {
		super(RemoteBitset.class, synchOn);
	}
	...
	public void fromByteStream(DataInputStream buffer, int updateSenderStateId) throws IOException {
		...
		for (int n = 0; n < collectionSize; n++) {
			RemoteBitset instance = new RemoteBitset(new BitsetResponse(), onServer);
