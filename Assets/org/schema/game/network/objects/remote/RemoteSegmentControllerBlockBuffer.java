...
public class RemoteSegmentControllerBlockBuffer extends RemoteBuffer<RemoteSegmentControllerBlock> {

	private static final int CONTROL_BATCH = 32;

	public RemoteSegmentControllerBlockBuffer(NetworkObject synchOn) {
		super(RemoteSegmentControllerBlock.class, synchOn);
	}
	...
	public void fromByteStream(DataInputStream buffer, int updateSenderStateId) throws IOException {
		...
		for (int n = 0; n < collectionSize; n++) {
			RemoteSegmentControllerBlock instance = new RemoteSegmentControllerBlock(new VoidUniqueSegmentPiece(), onServer);
