...
public class RemoteReactorBonusUpdateBuffer extends RemoteBuffer<RemoteReactorBonusMatrix> {

	private static final int CONTROL_BATCH = 32;

	public RemoteReactorBonusUpdateBuffer(NetworkObject synchOn) {
		super(RemoteReactorBonusMatrix.class, synchOn);
	}
	...
	public void fromByteStream(DataInputStream buffer, int updateSenderStateId) throws IOException {
		...
		for (int n = 0; n < collectionSize; n++) {
			RemoteReactorBonusMatrix instance = new RemoteReactorBonusMatrix(new ReactorBonusMatrixUpdate(), onServer);
