...
public class RemoteConversationBuffer extends RemoteBuffer<RemoteConversation> {

	private static final int CONTROL_BATCH = 32;

	public RemoteConversationBuffer(NetworkObject synchOn) {
		super(RemoteConversation.class, synchOn);
	}
	...
	public void fromByteStream(DataInputStream buffer, int updateSenderStateId) throws IOException {
		...
		for (int n = 0; n < collectionSize; n++) {
			RemoteConversation instance = new RemoteConversation(ConverationUpdate.deserializeStatic(buffer), onServer);
