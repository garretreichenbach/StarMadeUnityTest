...
public class RemoteInventoryFilterBuffer extends RemoteBuffer<RemoteInventoryFilter> {


	public RemoteInventoryFilterBuffer(NetworkObject synchOn) {
		super(RemoteInventoryFilter.class, synchOn);
	}
	...
	public void fromByteStream(DataInputStream buffer, int updateSenderStateId) throws IOException {
		...
		for (int n = 0; n < collectionSize; n++) {
			RemoteInventoryFilter instance = new RemoteInventoryFilter(new InventoryFilter(), onServer);
	...
	public int toByteStream(DataOutputStream buffer) throws IOException {
		...
		synchronized (get()) {
			...
			for (RemoteInventoryFilter remoteField : get()) {
