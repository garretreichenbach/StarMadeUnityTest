...
public class RemoteLongBooleanPairBuffer extends RemoteBuffer<RemoteLongBoolean> {

	private static final int CONTROL_BATCH = 8;

	public RemoteLongBooleanPairBuffer(NetworkObject synchOn) {
		super(RemoteLongBoolean.class, synchOn);
	}
	...
	public void fromByteStream(DataInputStream buffer, int updateSenderStateId) throws IOException {
		...
		for (int n = 0; n < collectionSize; n++) {
			RemoteLongBoolean instance = new RemoteLongBoolean(new LongBooleanPair(), onServer);
