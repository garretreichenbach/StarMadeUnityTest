...
public class RemoteReactorSet extends RemoteField<ReactorSet> {
	public RemoteReactorSet(ReactorSet entry, boolean synchOn) {
		super(entry, synchOn);
	}

	public RemoteReactorSet(ReactorSet entry, NetworkObject synchOn) {
		super(entry, synchOn);
	}
