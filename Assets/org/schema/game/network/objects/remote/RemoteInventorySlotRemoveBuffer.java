...
public class RemoteInventorySlotRemoveBuffer extends RemoteBuffer<RemoteInventorySlotRemove> {

	private static final int CONTROL_BATCH = 16;

	public RemoteInventorySlotRemoveBuffer(NetworkObject synchOn) {
		super(RemoteInventorySlotRemove.class, synchOn);
	}
	...
	public void fromByteStream(DataInputStream buffer, int updateSenderStateId) throws IOException {
		...
		for (int n = 0; n < collectionSize; n++) {
			RemoteInventorySlotRemove instance = new RemoteInventorySlotRemove(new InventorySlotRemoveMod(), onServer);
