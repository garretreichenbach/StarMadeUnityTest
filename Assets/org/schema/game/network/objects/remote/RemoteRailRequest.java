...
public class RemoteRailRequest extends RemoteField<RailRequest> {

	public RemoteRailRequest(RailRequest e, boolean onServer) {
		super(e, onServer);
	}

	public RemoteRailRequest(RailRequest e, NetworkObject synchOn) {
		super(e, synchOn);
	}
