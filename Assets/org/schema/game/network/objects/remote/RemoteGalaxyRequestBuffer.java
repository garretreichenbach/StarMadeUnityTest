...
public class RemoteGalaxyRequestBuffer extends RemoteBuffer<RemoteGalaxyRequest> {

	public RemoteGalaxyRequestBuffer(NetworkObject synchOn) {
		super(RemoteGalaxyRequest.class, synchOn);
	}
	...
	public void fromByteStream(DataInputStream buffer, int updateSenderStateId) throws IOException {
		...
		for (int n = 0; n < collectionSize; n++) {
			RemoteGalaxyRequest instance = new RemoteGalaxyRequest(new GalaxyRequestAndAwnser(), onServer);
	...
	public int toByteStream(DataOutputStream buffer) throws IOException {
		...
		synchronized (get()) {
			...
			for (RemoteGalaxyRequest remoteField : get()) {
