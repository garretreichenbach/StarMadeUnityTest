...
public class RemoteMapEntryAnswerBuffer extends RemoteBuffer<RemoteMapEntryAnswer> {

	public RemoteMapEntryAnswerBuffer(NetworkObject synchOn) {
		super(RemoteMapEntryAnswer.class, synchOn);
	}
	...
	public void fromByteStream(DataInputStream buffer, int updateSenderStateId) throws IOException {
		...
		for (int n = 0; n < collectionSize; n++) {
			RemoteMapEntryAnswer instance = new RemoteMapEntryAnswer(new GameMapAnswer(), onServer);
	...
	public int toByteStream(DataOutputStream buffer) throws IOException {
		...
		synchronized (get()) {
			...
			for (RemoteMapEntryAnswer remoteField : get()) {
