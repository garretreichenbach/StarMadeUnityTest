...
public class RemoteShortIntPairBuffer extends RemoteBuffer<RemoteShortIntPair> {

	private static final int CONTROL_BATCH = 8;

	public RemoteShortIntPairBuffer(NetworkObject synchOn) {
		super(RemoteShortIntPair.class, synchOn);
	}
	...
	public void fromByteStream(DataInputStream buffer, int updateSenderStateId) throws IOException {
		...
		for (int n = 0; n < collectionSize; n++) {
			RemoteShortIntPair instance = new RemoteShortIntPair(new ShortIntPair(), onServer);
