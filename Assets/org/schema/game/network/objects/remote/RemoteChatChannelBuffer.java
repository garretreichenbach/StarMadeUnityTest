...
public class RemoteChatChannelBuffer extends RemoteBuffer<RemoteChatChannel> {

	private static final int CONTROL_BATCH = 32;

	public RemoteChatChannelBuffer(boolean synchOn) {
		super(RemoteChatChannel.class, synchOn);
	}

	public RemoteChatChannelBuffer(NetworkObject synchOn) {
		super(RemoteChatChannel.class, synchOn);
	}
	...
	public void fromByteStream(DataInputStream buffer, int updateSenderStateId) throws IOException {
		...
		for (int n = 0; n < collectionSize; n++) {
			RemoteChatChannel instance = new RemoteChatChannel(new ChatChannelModification(), onServer);
