...
public class RemoteCreateDockBuffer extends RemoteBuffer<RemoteCreateDock> {

	private static final int CONTROL_BATCH = 16;

	public RemoteCreateDockBuffer(NetworkObject synchOn) {
		super(RemoteCreateDock.class, synchOn);
	}
	...
	public void fromByteStream(DataInputStream buffer, int updateSenderStateId) throws IOException {
		...
		for (int n = 0; n < collectionSize; n++) {
			RemoteCreateDock instance = new RemoteCreateDock(new CreateDockRequest(), onServer);
