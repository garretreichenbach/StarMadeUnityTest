...
public class RemoteCockpitManagerBuffer extends RemoteBuffer<RemoteCockpitManager> {

	private static final int CONTROL_BATCH = 32;
	private final CockpitManager cockpitManager;

	
	public RemoteCockpitManagerBuffer(NetworkObject synchOn, CockpitManager cockpitManager) {
		super(RemoteCockpitManager.class, synchOn);
	...
	public void fromByteStream(DataInputStream buffer, int updateSenderStateId) throws IOException {
		...
		for (int n = 0; n < collectionSize; n++) {
			RemoteCockpitManager instance = new RemoteCockpitManager(cockpitManager, onServer);
