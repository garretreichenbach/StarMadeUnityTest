...
public class RemoteFTLConnectionUpdateBuffer extends RemoteBuffer<RemoteFTLConnection> {

	public RemoteFTLConnectionUpdateBuffer(NetworkObject synchOn) {
		super(RemoteFTLConnection.class, synchOn);
	}
	...
	public void fromByteStream(DataInputStream buffer, int updateSenderStateId) throws IOException {
		...
		for (int n = 0; n < collectionSize; n++) {
			RemoteFTLConnection instance = new RemoteFTLConnection(new FTLConnection(), onServer);
	...
	public int toByteStream(DataOutputStream buffer) throws IOException {
		...
		synchronized (get()) {
			...
			for (RemoteFTLConnection remoteField : get()) {
