...
public class RemoteCrewFleetBuffer extends RemoteBuffer<RemoteCrewFleet> {

	private static final int CONTROL_BATCH = 32;

	public RemoteCrewFleetBuffer(NetworkObject synchOn) {
		super(RemoteCrewFleet.class, synchOn);
	}
	...
	public void fromByteStream(DataInputStream buffer, int updateSenderStateId) throws IOException {
		...
		for (int n = 0; n < collectionSize; n++) {
			RemoteCrewFleet instance = new RemoteCrewFleet(new CrewFleetRequest(), onServer);
