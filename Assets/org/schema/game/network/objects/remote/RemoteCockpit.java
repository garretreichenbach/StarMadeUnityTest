...
public class RemoteCockpit extends RemoteField<Cockpit> {
	public RemoteCockpit(Cockpit entry, boolean synchOn) {
		super(entry, synchOn);
	}

	public RemoteCockpit(Cockpit entry, NetworkObject synchOn) {
		super(entry, synchOn);
	}
