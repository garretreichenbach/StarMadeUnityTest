...
public class NetworkShop extends NetworkSegmentController implements NetworkInventoryInterface, ShopNetworkInterface {
	...
	public NetworkShop(StateInterface state, SendableSegmentController spaceStation) {
