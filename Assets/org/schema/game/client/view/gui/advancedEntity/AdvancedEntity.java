...
public class AdvancedEntity extends AdvancedGUIBuildModeLeftElement{

	private int topOffsetX = 32;
	private int offsetLeft = 16;
	public AdvancedEntity(GameClientState state) {
		super(state);
	...
	protected void addGroups(List<AdvancedGUIGroup> g) {
		g.add(new AdvancedEntityReactor(this));
		g.add(new AdvancedEntityThruster(this));
		g.add(new AdvancedEntityCannon(this));
		g.add(new AdvancedEntityBeams(this));
		g.add(new AdvancedEntityMissiles(this));
	}
