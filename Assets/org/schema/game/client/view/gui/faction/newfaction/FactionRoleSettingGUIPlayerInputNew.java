...
public class FactionRoleSettingGUIPlayerInputNew extends GUIInputPanel {

	private Faction faction;
	private FactionRolesScrollableListNew sc;

	public FactionRoleSettingGUIPlayerInputNew(InputState state,
	                                           FactionRolesDialogNew d, Faction faction) {
		super("FactionRoleSettingGUIPlayerInputNew", state, 300, 450, d, Lng.str("Edit Roles"), "");
