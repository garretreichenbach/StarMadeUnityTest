...
public class FactionOutgoingInvitationsPanel extends FactionInvitationsAbstractScrollList {

	public FactionOutgoingInvitationsPanel(float width, float height, InputState state) {
		super(width, height, state);
	}

	@Override
	public boolean equals(Object o) {
		return o instanceof FactionOutgoingInvitationsPanel;
	}
		...
		public void callback(GUIElement callingGuiElement, MouseEvent event) {
			if (event.pressedLeftMouse()) {
				if ("REVOKE".equals(callingGuiElement.getUserPointer())) {
					...
					AudioController.fireAudioEventID(453);
