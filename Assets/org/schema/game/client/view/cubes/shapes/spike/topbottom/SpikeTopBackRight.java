...
public class SpikeTopBackRight extends SpikeShapeAlgorithm {
	...
	protected int[][] getNormals(){
		return new int[][]{{Element.TOP, Element.RIGHT}, {Element.TOP, Element.FRONT}}; 
	}
	@Override
