...
@BlockShape(name = "SpikeRightBackLeft")
public class SpikeRightBackLeft extends SpikeShapeAlgorithm {

	private final int[] sidesToTest = new int[]{Element.LEFT};
	private org.schema.game.common.data.physics.ConvexHullShapeExt shape;

	public SpikeRightBackLeft() {
		super();
	...
	protected int[][] getNormals(){
		return new int[][]{{Element.RIGHT, Element.BOTTOM}, {Element.RIGHT, Element.BACK}}; 
	}
	@Override
