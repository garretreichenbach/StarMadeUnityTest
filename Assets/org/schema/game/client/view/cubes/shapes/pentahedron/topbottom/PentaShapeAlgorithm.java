...
public abstract class PentaShapeAlgorithm extends BlockShapeAlgorithm implements IconInterface {
	private int normal;
	...
	protected int getAngledSideLightRepresentitive(int sideId, int normal) {
		...
		if(normal == this.normal){
			return getSidesAngled()[0]; //extra side
