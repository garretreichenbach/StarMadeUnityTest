...
@BlockShape(name = "TetrahedronBottomFrontRight")
public class TetrahedronBottomFrontRight extends TetrahedronShapeAlgorithm {
	...
	public TetrahedronBottomFrontRight() {
		super();
