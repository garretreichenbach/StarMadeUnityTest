...
public class SpikeLeftBackRight extends SpikeShapeAlgorithm {
	...
	protected int[][] getNormals(){
		return new int[][]{{Element.LEFT, Element.BOTTOM}, {Element.LEFT, Element.FRONT}}; 
	}
	@Override
