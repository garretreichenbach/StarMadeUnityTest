...
@BlockShape(name = "WedgeLeftFront")
public class WedgeLeftFront extends WedgeShapeAlgorithm {

	private final int[] sidesAngled = new int[]{Element.RIGHT};
	private final int[] sidesToTest = new int[]{Element.LEFT, Element.FRONT};
	private org.schema.game.common.data.physics.ConvexHullShapeExt shape;

	public WedgeLeftFront() {
		super();
	...
	public byte[] getWedgeOrientation() {
		return new byte[]{Element.BACK, Element.RIGHT};
	}
