...
@BlockShape(name = "SpikeBottomFrontRight")
public class SpikeBottomFrontRight extends SpikeShapeAlgorithm {

	private final int[] sidesToTest = new int[]{Element.TOP};
	private org.schema.game.common.data.physics.ConvexHullShapeExt shape;
	public SpikeBottomFrontRight() {
		super();
	...
	protected int[][] getNormals(){
		return new int[][]{{Element.BOTTOM, Element.RIGHT}, {Element.BOTTOM, Element.BACK}}; 
	}
	@Override
