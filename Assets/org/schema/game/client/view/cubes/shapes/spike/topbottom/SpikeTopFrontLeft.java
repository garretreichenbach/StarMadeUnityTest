...
public class SpikeTopFrontLeft extends SpikeShapeAlgorithm {
	...
	protected int[][] getNormals(){
		return new int[][]{{Element.LEFT, Element.TOP}, {Element.TOP, Element.BACK}}; 
	}
	@Override
